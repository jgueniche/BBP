  ...
  return (
    <div className={cn("flex items-end gap-3", className)}>
      ...
      <motion.div
        ...
        className="min-w-0 max-w-[80%] rounded-lg rounded-bl-[4px] bg-boutargue px-4 py-3 text-[15px] font-medium break-words whitespace-pre-wrap text-[#0b0b0b] shadow-soft"
      >
        {children}
      </motion.div>
    </div>
