export const fr = {
  ...
  nav: {
    ...
    coach: "Kémia",
    coachSubtitle: "ta coach, toujours là",
    profil: "Moi",
    groupSuivi: "Mon suivi",
    groupCuisine: "Cuisine & communauté",
  },
  accueil: {
    title: "Aujourd'hui",
    greeting: "Bonjour",
    caloriesTile: "Calories",
    caloriesOf: "sur",
    caloriesUnit: "kcal",
    noTarget: "Mode Boutargue : pas de cible stricte, on suit la tendance.",
    fastNoTarget: "Jour de jeûne — aucun objectif calorique aujourd'hui.",
    proteinTile: "Protéines",
    weightTile: "Poids — tendance",
    weightPerWeek: "kg / sem",
    weightEmpty: "Ajoute une première pesée pour voir ta tendance.",
    weightCta: "Voir mes progrès",
    streakTile: "Série journal",
    streakDays: "jours",
    streakBest: "record :",
    streakTolerance: "chabbat ne casse jamais la série",
    plateTitle: "Aujourd'hui dans ton assiette",
    plateOpenJournal: "Ouvrir le journal",
    plateEmpty:
    ...
    planningCta: "Voir la semaine",
    kemiaCta: "Ouvrir la conversation",
    kemiaDefault:
      "Raconte-moi ta journée quand tu veux — je suis là, et le thé est chaud.",
    kemiaErev:
      "Chabbat approche, allumage à {time}. On prévoit un beau vendredi soir ?",
    candleTitle: "Chabbat & fêtes",
    candleInfo: "Allumage {day} à {time}",
    candleNote: "Jour exempt : ta série continue, profite.",
  },
  auth: {
